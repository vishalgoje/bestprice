...
<a href="#" data-target=".filter--bags, .filter--hats" class="selectable"><i class="box"></i> Nokia</a>
<a href="#" data-target=".filter--shorts" class="selectable"><i class="box"></i> Samsong</a>
<a href="#" data-target=".filter--polo-shirts" class="selectable"><i class="box"></i> HTC</a>
<a href="#" data-target=".filter--shirts" class="selectable"><i class="box"></i> Sony </a>
                        ...
                        <div class="accordion-group" id="tourStep3">
                            <div class="accordion-heading">
                                <a class="accordion-toggle collapsed" data-toggle="collapse" href="#filterTwo">Screen Size <b class="caret"></b></a>
                            </div>
...
<a href="#" data-target="s" data-type="size" class="selectable detailed"><i class="box"></i> 3 inch</a>
<a href="#" data-target="m" data-type="size" class="selectable detailed"><i class="box"></i> 1.2 inch</a>
<a href="#" data-target="l" data-type="size" class="selectable detailed"><i class="box"></i> 4 inch</a>
<a href="#" data-target="xl" data-type="size" class="selectable detailed"><i class="box"></i> 6 inch</a>
<a href="#" data-target="xxl" data-type="size" class="selectable detailed"><i class="box"></i> 3.5 inch</a>
                                </div>
                            </div>
                        </div> <!-- /size filter -->
...
<a href="#" data-target="shred" data-type="brand" class="selectable detailed"><i class="box"></i> Shred</a>
                ...
                <section class="span9">
                    ...
                    <div class="underlined push-down-20">
                        <div class="row">
                            <div class="span4">
                                <h3><span class="light">All</span> M</h3>
                            </div>
                    	    ...
                    	    <div class="span3 isotope--target filter--polo-shirts" data-price="92" data-popularity="1" data-size="s|xxl" data-color="orange" data-brand="shred">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                ...
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-1.jpg.pagespeed.ce.Da1RubYOlL.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                        <form method="post" action="sproduct.php">
                                                            
                                                             <button type="submit" name="submit" value="images/dummy/M/product-1.jpg.pagespeed.ce.Da1RubYOlL.jpg" class="btn more btn-primary">
                                                             More
                                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--bags" data-price="1545" data-popularity="3" data-size="s|m|xl|xxl" data-color="pink|purple" data-brand="shred">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-2.jpg.pagespeed.ce.EDQe3gHrr41.jpg"/></a>
                        	                    <div class="img-overlay">

                        	                    		  <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-2.jpg.pagespeed.ce.EDQe3gHrr41.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
				                                             <input  type="hidden" name="rs" value="1545">
				                                             <input type="hidden" name="pname" value="Nokia 345">
				                                            <a href="#" class="btn buy btn-danger">Buy</a>
                    	    ...
                    	    <div class="span3 isotope--target filter--shirts" data-price="1041" data-popularity="3" data-size="xs|s|xl" data-color="green|blue" data-brand="s-oliver">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-3.jpg.pagespeed.ce.YWPViY8cOl1.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                    	  <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-3.jpg.pagespeed.ce.YWPViY8cOl1.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--bags" data-price="736" data-popularity="5" data-size="xs|s|l|xxl" data-color="red|pink" data-brand="adidas">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-4.jpg.pagespeed.ce.bHDWegjUym1.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                       <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-4.jpg.pagespeed.ce.bHDWegjUym1.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
				                                             <input  type="hidden" name="rs" value="736">
				                                             <input type="hidden" name="pname" value="Nokia 3">
				                                            <a href="#" class="btn buy btn-danger">Buy</a>
                        	            ...
                        	            <div class="main-titles no-margin">
                        	                ...
                        	                <h5 class="no-margin isotope--title">Nokia</h5>
                        	            </div>
                        	            <div class="row-fluid hidden-line">
                                            <div class="span6">
                                                <a href="#" class="btn btn-small"><i class="icon-heart"></i></a>
                    	    ...
                    	    <div class="span3 isotope--target filter--sunglasses" data-price="1581" data-popularity="1" data-size="xs|s|m|l" data-color="red|pink" data-brand="puma">
                    	        <div class="product">
                                    <div class="product-inner">
                    	                                        	            ...
                    	                                        	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-5.jpg.pagespeed.ce.4JLR3ZeQEC.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                 <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-5.jpg.pagespeed.ce.4JLR3ZeQEC.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--suits" data-price="1488" data-popularity="1" data-size="s|m|l" data-color="pink" data-brand="puma">
                    	        <div class="product">
                                    <div class="product-inner">
                    	                                        	            ...
                    	                                        	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-13.jpg.pagespeed.ce.n4S9S9r0y1.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                        <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-13.jpg.pagespeed.ce.n4S9S9r0y1.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--swimwear" data-price="249" data-popularity="1" data-size="s|m|xxl" data-color="orange" data-brand="puma">
                    	        <div class="product">
                                    <div class="product-inner">
                    	                                        	            ...
                    	                                        	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-7.jpg.pagespeed.ce.HyGb3bENJ7.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                           <form method="post" action="sproduct.php">
                                                            
                                                             <button type="submit" name="submit" value="images/dummy/M/product-7.jpg.pagespeed.ce.HyGb3bENJ7.jpg" class="btn more btn-primary">
                                                             More
                                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--trousers" data-price="699" data-popularity="5" data-size="xs|l|xl|xxl" data-color="purple" data-brand="s-oliver">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-8.jpg.pagespeed.ce.1vv0RltX3O.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                     <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-8.jpg.pagespeed.ce.1vv0RltX3O.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--socks" data-price="161" data-popularity="5" data-size="xs|m|xl|xxl" data-color="blue|pink" data-brand="s-oliver">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-9.jpg.pagespeed.ce.pgB4xkmiXd1.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                        <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-9.jpg.pagespeed.ce.pgB4xkmiXd1.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--accessories" data-price="1055" data-popularity="1" data-size="l|xxl" data-color="blue" data-brand="s-oliver">
                    	        <div class="product">
                                    <div class="product-inner">
                    	                                        	            ...
                    	                                        	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-10.jpg.pagespeed.ce.I4zh8RM_A8.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                     <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-10.jpg.pagespeed.ce.I4zh8RM_A8.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--chinos" data-price="1027" data-popularity="3" data-size="xs|m|xl|xxl" data-color="green|purple" data-brand="puma">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-11.jpg.pagespeed.ce.dhG92Aw57l.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                       <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-11.jpg.pagespeed.ce.dhG92Aw57l.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--underwear" data-price="1685" data-popularity="1" data-size="xs|m|xl" data-color="purple" data-brand="shred">
                    	        <div class="product">
                                    <div class="product-inner">
                    	                                        	            ...
                    	                                        	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-12.jpg.pagespeed.ce.v5dCplkcke.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                      <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-12.jpg.pagespeed.ce.v5dCplkcke.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--suits" data-price="121" data-popularity="4" data-size="xs|m|l|xl" data-color="green|pink" data-brand="nike">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-14.jpg.pagespeed.ce.A3Xy9rc3L6.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                           <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-14.jpg.pagespeed.ce.A3Xy9rc3L6.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--shirts" data-price="309" data-popularity="5" data-size="xs|s|m|xl" data-color="blue|pink" data-brand="naish">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-15.jpg.pagespeed.ce.2nvdKLn9rh1.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                              <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-15.jpg.pagespeed.ce.2nvdKLn9rh1.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--boots" data-price="822" data-popularity="3" data-size="xs|s|xl|xxl" data-color="pink|purple" data-brand="naish">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-16.jpg.pagespeed.ce.VRzvgI1NSs1.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                             <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-13.jpg.pagespeed.ce.n4S9S9r0y1" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--chinos" data-price="1249" data-popularity="5" data-size="xs|s|m|l" data-color="orange" data-brand="adidas">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-9.jpg.pagespeed.ce.pgB4xkmiXd.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                              <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-9.jpg.pagespeed.ce.pgB4xkmiXd.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                              ...
                              <div class="span3 isotope--target filter--chinos" data-price="1249" data-popularity="5" data-size="xs|s|m|l" data-color="orange" data-brand="adidas">
                                <div class="product">
                                    <div class="product-inner">
                                                                                <div class="product-img">
                                            <div class="picture">
                                                <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-6.jpg.pagespeed.ce.XI0HBrK_zM.jpg"/></a>
                                                <div class="img-overlay">
                                                    <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-6.jpg.pagespeed.ce.XI0HBrK_zM.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                              ...
                              <div class="span3 isotope--target filter--chinos" data-price="1249" data-popularity="5" data-size="xs|s|m|l" data-color="orange" data-brand="adidas">
                                <div class="product">
                                    <div class="product-inner">
                                                                                <div class="product-img">
                                            <div class="picture">
                                                <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-34.jpg.pagespeed.ce.qmvgXoakgS.jpg"/></a>
                                                <div class="img-overlay">
                                                      <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-34.jpg.pagespeed.ce.qmvgXoakgS.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                              ...
                              <div class="span3 isotope--target filter--chinos" data-price="1249" data-popularity="5" data-size="xs|s|m|l" data-color="orange" data-brand="adidas">
                                <div class="product">
                                    <div class="product-inner">
                                                                                <div class="product-img">
                                            <div class="picture">
                                                <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/shirt-1.jpg.pagespeed.ce.Pi4WnL75ui.jpg"/></a>
                                                <div class="img-overlay">
                                                         <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/shirt-1.jpg.pagespeed.ce.Pi4WnL75ui.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                              ...
                              <div class="span3 isotope--target filter--chinos" data-price="1249" data-popularity="5" data-size="xs|s|m|l" data-color="orange" data-brand="adidas">
                                <div class="product">
                                    <div class="product-inner">
                                                                                <div class="product-img">
                                            <div class="picture">
                                                <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/shirt-2.jpg.pagespeed.ce.1mS04Ek51W.jpg"/></a>
                                                <div class="img-overlay">
                                                      <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/shirt-2.jpg.pagespeed.ce.1mS04Ek51W.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                              ...
                              <div class="span3 isotope--target filter--chinos" data-price="1249" data-popularity="5" data-size="xs|s|m|l" data-color="orange" data-brand="adidas">
                                <div class="product">
                                    <div class="product-inner">
                                                                                <div class="product-img">
                                            <div class="picture">
                                                <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/shirt-3.jpg.pagespeed.ce.NeiPCCrCap.jpg"/></a>
                                                <div class="img-overlay">
                                                         <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/shirt-3.jpg.pagespeed.ce.NeiPCCrCap.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--shorts" data-price="420" data-popularity="4" data-size="s|l" data-color="green" data-brand="shred">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-2.jpg.pagespeed.ce.EDQe3gHrr4.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                               <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-2.jpg.pagespeed.ce.EDQe3gHrr4.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                            ...
                            <div class="span3 isotope--target filter--shorts" data-price="420" data-popularity="4" data-size="s|l" data-color="green" data-brand="shred">
                                <div class="product">
                                    <div class="product-inner">
                                                                                <div class="product-img">
                                            <div class="picture">
                                                <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-3.jpg.pagespeed.ce.YWPViY8cOl.jpg"/></a>
                                                <div class="img-overlay">
                                                <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-3.jpg.pagespeed.ce.YWPViY8cOl.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
				                                             <input  type="hidden" name="rs" value="899">
				                                             <input type="hidden" name="pname" value="Lee">
                            ...
                            <div class="span3 isotope--target filter--shorts" data-price="420" data-popularity="4" data-size="s|l" data-color="green" data-brand="shred">
                                <div class="product">
                                    <div class="product-inner">
                                                                                <div class="product-img">
                                            <div class="picture">
                                                <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-4.jpg.pagespeed.ce.bHDWegjUym.jpg"/></a>
                                                <div class="img-overlay">
                                                   <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-4.jpg.pagespeed.ce.bHDWegjUym.jpg"class="btn more btn-primary">
				                                             More
				                                             </button>
				                                             <input  type="hidden" name="rs" value="1999">
                    	    ...
                    	    <div class="span3 isotope--target filter--t-shirts" data-price="487" data-popularity="2" data-size="s|l" data-color="blue|pink" data-brand="s-oliver">
                    	        <div class="product">
                                    <div class="product-inner">
                	                                            	            ...
                	                                            	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-19.jpg.pagespeed.ce.5HEt0o7OAB.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                          <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-19.jpg.pagespeed.ce.5HEt0o7OAB.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--trainers" data-price="184" data-popularity="5" data-size="l|xxl" data-color="pink|purple" data-brand="shred">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-20.jpg.pagespeed.ce.F7BAxYDbLX1.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                         <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-20.jpg.pagespeed.ce.F7BAxYDbLX1.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--polo-shirts" data-price="421" data-popularity="5" data-size="m|xxl" data-color="red" data-brand="naish">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-21.jpg.pagespeed.ce.yYDOdqD4v1.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                           <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-21.jpg.pagespeed.ce.yYDOdqD4v1.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
				                                             <input  type="hidden" name="rs" value="899">
				                                             <input type="hidden" name="pname" value="HTC 2983">
				                                            <a href="#" class="btn buy btn-danger">Buy</a>
                        	            ...
                        	            <div class="main-titles no-margin">
                        	                <h4 class="title">₹ 899</h4>
                        	                <h5 class="no-margin isotope--title">HTC 2983</h5>
                        	            </div>
                        	            <div class="row-fluid hidden-line">
                                            <div class="span6">
                                                <a href="#" class="btn btn-small"><i class="icon-heart"></i></a>
                    	    ...
                    	    <div class="span3 isotope--target filter--t-shirts" data-price="286" data-popularity="5" data-size="xs|s|m" data-color="blue|pink" data-brand="puma">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-20.jpg.pagespeed.ce.F7BAxYDbLX.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                          <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-20.jpg.pagespeed.ce.F7BAxYDbLX.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                            ...
                            <div class="span3 isotope--target filter--t-shirts" data-price="286" data-popularity="5" data-size="xs|s|m" data-color="blue|pink" data-brand="puma">
                                <div class="product">
                                    <div class="product-inner">
                                                                                <div class="product-img">
                                            <div class="picture">
                                                <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-27.jpg.pagespeed.ce.uQO61sTD6h.jpg"/></a>
                                                <div class="img-overlay">
                                                      <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-27.jpg.pagespeed.ce.uQO61sTD6h.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--t-shirts" data-price="576" data-popularity="2" data-size="m|l" data-color="red|purple" data-brand="puma">
                    	        <div class="product">
                                    <div class="product-inner">
                	                                            	            ...
                	                                            	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-23.jpg.pagespeed.ce.myNttexobP.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                          <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-23.jpg.pagespeed.ce.myNttexobP.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                             ...
                             <div class="span3 isotope--target filter--t-shirts" data-price="576" data-popularity="2" data-size="m|l" data-color="red|purple" data-brand="puma">
                                <div class="product">
                                    <div class="product-inner">
                                                                                ...
                                                                                <div class="product-img">
                                            <div class="picture">
                                                <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-24.jpg.pagespeed.ce.lEoWFT7nFI.jpg"/></a>
                                                <div class="img-overlay">
                                                     <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-24.jpg.pagespeed.ce.lEoWFT7nFI.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
				                                             <input  type="hidden" name="rs" value="899">
				                                             <input type="hidden" name="pname" value="Polo">
                             ...
                             <div class="span3 isotope--target filter--t-shirts" data-price="576" data-popularity="2" data-size="m|l" data-color="red|purple" data-brand="puma">
                                <div class="product">
                                    <div class="product-inner">
                                                                                ...
                                                                                <div class="product-img">
                                            <div class="picture">
                                                <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-26.jpg.pagespeed.ce.nQWAYlt5Ha.jpg"/></a>
                                                <div class="img-overlay">
                                                      <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-26.jpg.pagespeed.ce.nQWAYlt5Ha.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--vests" data-price="54" data-popularity="4" data-size="xs|s|l|xxl" data-color="blue|pink" data-brand="s-oliver">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-25.jpg.pagespeed.ce.xJJfKy1ctx.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                            <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-25.jpg.pagespeed.ce.xJJfKy1ctx.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
				                                             <input  type="hidden" name="rs" value="699">
                    	    ...
                    	    <div class="span3 isotope--target filter--trainers" data-price="1016" data-popularity="5" data-size="xs|s|m|xxl" data-color="red" data-brand="puma">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-26.jpg.pagespeed.ce.nQWAYlt5Ha1.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                        <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-26.jpg.pagespeed.ce.nQWAYlt5Ha1.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--blazers" data-price="1368" data-popularity="4" data-size="xs|l" data-color="blue|purple" data-brand="naish">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-28.jpg.pagespeed.ce.KafkrIYpz7.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                     <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-28.jpg.pagespeed.ce.KafkrIYpz7.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--shorts" data-price="454" data-popularity="4" data-size="xs|s|l|xl" data-color="green|pink" data-brand="puma">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-22.jpg.pagespeed.ce.z0Qhm86STl.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                            <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-22.jpg.pagespeed.ce.z0Qhm86STl.jpg"" class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--bags" data-price="228" data-popularity="3" data-size="s|xl|xxl" data-color="blue" data-brand="shred">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-30.jpg.pagespeed.ce.7Sx6wEwaD0.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                               <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-30.jpg.pagespeed.ce.7Sx6wEwaD0.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
				                                             <input  type="hidden" name="rs" value="2228">
				                                             <input type="hidden" name="pname" value="Nokia lumia 330">
				                                            <a href="#" class="btn buy btn-danger">Buy</a>
                        	            ...
                        	            <div class="main-titles no-margin">
                        	                ...
                        	                <h5 class="no-margin isotope--title">Nokia lumia 330</h5>
                        	            </div>
                        	            <div class="row-fluid hidden-line">
                                            <div class="span6">
                                                <a href="#" class="btn btn-small"><i class="icon-heart"></i></a>
                    	    ...
                    	    <div class="span3 isotope--target filter--bags" data-price="1045" data-popularity="5" data-size="s|m|l|xl" data-color="red" data-brand="puma">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-31.jpg.pagespeed.ce.qcxMmISnaf1.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                             <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-31.jpg.pagespeed.ce.qcxMmISnaf1.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
				                                             <input  type="hidden" name="rs" value="1045">
				                                             <input type="hidden" name="pname" value="Nokia Xoxo">
				                                            <a href="#" class="btn buy btn-danger">Buy</a>
                    	        ...
                    	        <div class="product">
                                    <div class="product-inner">
                        	                ...
                        	                <div class="picture">
                                               ...
                                               <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/540x374xproduct-32.jpg.pagespeed.ic.cYj7H0BB4k.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                            <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/540x374xproduct-32.jpg.pagespeed.ic.cYj7H0BB4k.jpg"class="btn more btn-primary">
				                                             More
				                                             </button>
                    	    ...
                    	    <div class="span3 isotope--target filter--shirts" data-price="3" data-popularity="5" data-size="xs|m" data-color="pink" data-brand="puma">
                    	        <div class="product">
                                    <div class="product-inner">
                        	                                    	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/m/product-33.jpg.pagespeed.ce.ScmDb1T3Wy1.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                        <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/m/product-33.jpg.pagespeed.ce.ScmDb1T3Wy1.jpg"class="btn more btn-primary">
				                                             More
				                                             </button>
				                                             <input  type="hidden" name="rs" value="399">
				                                             <input type="hidden" name="pname" value="Sony 23">
				                                            <a href="#" class="btn buy btn-danger">Buy</a>
                        	            ...
                        	            <div class="main-titles no-margin">
                        	                ...
                        	                <h5 class="no-margin isotope--title">Sony 23</h5>
                        	            </div>
                        	            <div class="row-fluid hidden-line">
                                            <div class="span6">
                                                <a href="#" class="btn btn-small"><i class="icon-heart"></i></a>
                    	    ...
                    	    <div class="span3 isotope--target filter--blazers" data-price="1120" data-popularity="1" data-size="s|xl|xxl" data-color="pink" data-brand="adidas">
                    	        <div class="product">
                                    <div class="product-inner">
                    	                                        	            ...
                    	                                        	            <div class="product-img">
                        	                <div class="picture">
                        	                    <a href="product.html"><img width="540" height="374" alt="" src="images/dummy/M/product-35.jpg.pagespeed.ce.2_Bct1j-Do.jpg"/></a>
                        	                    <div class="img-overlay">
                        	                               <form method="post" action="sproduct.php">
				                                            
				                                             <button type="submit" name="submit" value="images/dummy/M/product-35.jpg.pagespeed.ce.2_Bct1j-Do.jpg" class="btn more btn-primary">
				                                             More
				                                             </button>
...
Aliquam tincidunt vestibulum risus et gravida.</p>
        ...
        <div class="foot-last">
            ...
            <div class="container">
                <div class="row">
                    <div class="span6">
                        &copy; Copyright 2014. Images of M by <a target="_blank" href="http://www.horsefeathers.eu/">SSBV</a>.
                    </div>
                    <div class="span6">
