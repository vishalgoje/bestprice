                ...
                <div class="row">
                    <div class="span4">
                        <div class="higher-line">
                            Wellcome! Please  
                            <a href="" role="button" data-toggle="modal"><?php echo $login_session; ?></a> | <?php echo $email; ?>|
                            ...
                            <li class="row"><!-- .megamenu--half for 2 cols, .megamenu--third for 3 cols -->
                                <div class="span1">
                                    ...
                                    <ul class="nav unstyled">
                                        <li><a href="shopcMobiles.html">Samsung</a></li>
                                        <li><a href="shopcMobiles.html">Nokia</a></li>
                                        <li><a href="shopcMobiles.html">Apple</a></li>
                                         <li><a href="shopcMobiles.html">Blackberry</a></li>
                                         <li><a href="shopcMobiles.html">Sony</a></li>
                                         <li><a href="shopcMobiles.html">Motorola</a></li>
                                    </ul>
                ...
                <div class="cart-container" id="cartContainer">
                    ...
                    <div class="open-panel">
                        ...
                        <form method="post" action="scheckout-step-1.php" >
                           ...
                           <a> <small>Shipping costs are calculated based on location. <a href="#">More information</a></small>
                        </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="slide">
    	            	            ...
    	            	            <div class="picture">
    	            	        		...
    	            	        		<div class="img-overlay">
    	            	        		  <form method="post" action="sproduct.php">
                                             ...
                                             <input  type="hidden" name="rs" value="1116">
                                             <input type="hidden" name="pname" value="Productcode 752">
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	            ...
    	            	            <div class="picture">
    	            	        		...
    	            	        		<div class="img-overlay">
                                         <form method="post" action="sproduct.php">
                                             ...
                                             <button type="submit" name="submit" value="images/dummy/featured-products/featured-2.png.pagespeed.ce.bhpeQnpEiJ.png" class="btn more btn-primary">
                                             More
                                             </button>
                                             <input type="hidden" name="rs" value="2050">
                                             <input type="hidden" name="pname" value="Fast track bag">
                                            <a href="#" class="btn buy btn-danger">Buy</a>
    	            	        ...
    	            	        <div class="main-titles">
    	            	            <h4 class="title">₹  2050</h4>
    	            	            <h5 class="no-margin"><a href="product.html">Fast track bag</a></h5>
    	            	        </div>
    	            	        <p class="desc">Diwali Dhamaka offer 52% Off Mobiles and Clothing on the Best Price</p>
    	            	    </div>
                	      </div> <!-- /product -->
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	            ...
    	            	            <div class="picture">
    	            	        		...
    	            	        		<div class="img-overlay">
    	            	        		    <form method="post" action="sproduct.php">
                                             ...
                                             <button type="submit" name="submit" value="images/dummy/featured-products/featured-3.png.pagespeed.ce.GxdBosiqGe.png" class="btn more btn-primary">
                                             More
                                             </button>
                                             <input type="hidden" name="rs" value="1500">
                                             <input type="hidden" name="pname" value="Eathers">
                                            <a href="#" class="btn buy btn-danger">Buy</a>
    	            	        ...
    	            	        <div class="main-titles">
    	            	            ...
    	            	            <h5 class="no-margin"><a href="product.html">Eathers</a></h5>
    	            	        </div>
    	            	        <p class="desc">Diwali Dhamaka offer 52% Off Mobiles and Clothing on the Best Price</p>
    	            	    </div>
                	      </div> <!-- /product -->
                    ...
                    <div class="product">
            	       <div class="product-inner">
                	        <div class="product-img">
                                <div class="picture">
                                    ...
                                    <div class="img-overlay">
                                             ...
                                             <input type="hidden" name="rs" value="3098">
                                             <input type="hidden" name="pname" value="Polo shirt">
                                            <a href="#" class="btn buy btn-danger">Buy</a>
                            ...
                            <div class="main-titles no-margin">
                                <h4 class="title">₹  3098</h4>
                                <h5 class="no-margin">Polo shirt</h5>
                            </div>
                            <p class="desc">Diwali Dhamaka offer 52% Off Mobiles and Clothing on the Best Price</p>
            	...
            	<div class="span3">
                    <div class="product">
            	       <div class="product-inner">
                                ...
                                <div class="picture">
                                    ...
                                    <div class="img-overlay">
                                        <form method="post" action="sproduct.php">    
                                             ...
                                             <input type="hidden" name="rs" value="4579">
                                             <input type="hidden" name="pname" value="horsef shirt">
                                            <a href="#" class="btn buy btn-danger">Buy</a>
                            ...
                            <div class="main-titles no-margin">
                                <h4 class="title">₹  4579</h4>
                                <h5 class="no-margin">horesf shirt</h5>
                            </div>
                            <p class="desc">Diwali Dhamaka offer 52% Off Mobiles and Clothing on the Best Price</p>
                            <div class="row-fluid hidden-line">
                                <div class="span6">
                                ...
                                <div class="picture">
                                    ...
                                    <div class="img-overlay">
                                            <form method="post" action="sproduct.php">    
                                             ...
                                             <input type="hidden" name="rs" value="2500">
                                             <input type="hidden" name="pname" value="Productcode 306">
                                            <a href="#" class="btn buy btn-danger">Buy</a>
            	...
            	<div class="span3">
                    <div class="product">
            	       <div class="product-inner">
                                ...
                                <div class="picture">
                                    ...
                                    <div class="img-overlay">
                                           <form method="post" action="sproduct.php">    
                                             ...
                                             <input type="hidden" name="rs" value="6000">
                                             <input type="hidden" name="pname" value="striker pant">
                                            <a href="#" class="btn buy btn-danger">Buy</a>
                            ...
                            <div class="main-titles no-margin">
                                <h4 class="title">₹  6000</h4>
                                <h5 class="no-margin">striker pant</h5>
                            </div>
                            <p class="desc">Diwali Dhamaka offer 52% Off Mobiles and Clothing on the Best Price</p>
                            <div class="row-fluid hidden-line">
                                <div class="span6">
            	...
            	<div class="span3">
                    <div class="product">
            	       <div class="product-inner">
                                ...
                                <div class="picture">
                                    ...
                                    <div class="img-overlay">
                                            <form method="post" action="sproduct.php">    
                                             ...
                                             <input type="hidden" name="rs" value="7800">
                                             <input type="hidden" name="pname" value="Lee pant">
                                            <a href="#" class="btn buy btn-danger">Buy</a>
                            ...
                            <div class="main-titles no-margin">
                                <h4 class="title">₹  7800</h4>
                                <h5 class="no-margin">Lee pant</h5>
                            </div>
                            <p class="desc">Diwali Dhamaka offer 52% Off Mobiles and Clothing on the Best Price</p>
                            <div class="row-fluid hidden-line">
                                <div class="span6">
            	...
            	<div class="span3">
                    <div class="product">
            	       <div class="product-inner">
                	        <div class="product-img">
                                <div class="picture">
                                    ...
                                    <div class="img-overlay">
                                             ...
                                             <input type="hidden" name="rs" value="5700">
                                             <input type="hidden" name="pname" value="Johnhills pant">
                                            <a href="#" class="btn buy btn-danger">Buy</a>
                            ...
                            <div class="main-titles no-margin">
                                <h4 class="title">₹  5700</h4>
                                <h5 class="no-margin">Johnhills pant</h5>
                            </div>
                            <p class="desc">Diwali Dhamaka offer 52% Off Mobiles and Clothing on the Best Price</p>
                            <div class="row-fluid hidden-line">
                                <div class="span6">
                    ...
                    <div class="product">
            	       <div class="product-inner">
                                ...
                                <div class="picture">
                                    ...
                                    <div class="img-overlay">
                                            <form method="post" action="sproduct.php">    
                                             ...
                                             <input type="hidden" name="rs" value="2000">
                            ...
                            <div class="main-titles no-margin">
                                ...
                                <h5 class="no-margin">Puma shoes</h5>
                            </div>
                            <p class="desc">Diwali Dhamaka offer 52% Off Mobiles and Clothing on the Best Price</p>
                            <div class="row-fluid hidden-line">
                                <div class="span6">
            	...
            	<div class="span3">
                    <div class="product">
            	       <div class="product-inner">
                                ...
                                <div class="picture">
                                    ...
                                    <div class="img-overlay">
                                            <form method="post" action="sproduct.php">    
                                             ...
                                             <input type="hidden" name="rs" value="2560">
                            ...
                            <div class="main-titles no-margin">
                                <h4 class="title">₹  2560</h4>
                                <h5 class="no-margin">Horsef Cap</h5>
                            </div>
                            <p class="desc">Diwali Dhamaka offer 52% Off Mobiles and Clothing on the Best Price</p>
                            <div class="row-fluid hidden-line">
                                <div class="span6">
                        ...
                        <div class="product-inner">
                            <div class="product-img">
                                <div class="picture">
                                    ...
                                    <div class="img-overlay">
                                                    <form method="post" action="sproduct.php">    
                                             <button type="submit" name="submit" value="images/dummy/most-popular-products/popular-1.jpg.pagespeed.ce.oZ75GsaBt3.jpg" class="btn more btn-primary">
                                             More
                                             </button>
                                             <input type="hidden" name="rs" value="2436">
                                             <input type="hidden" name="pname" value="Horsef shirt">
                                            <a href="#" class="btn buy btn-danger">Buy</a>
                            ...
                            <div class="main-titles no-margin">
                                <h4 class="title">₹  2436</h4>
                                <h5 class="no-margin">Horsef shirt</h5>
                            </div>
                            <p class="desc">Diwali Dhamaka offer 52% Off Mobiles and Clothing on the Best Price</p>
                            <div class="row-fluid hidden-line">
                                <div class="span6">
                        ...
                        <div class="product-inner">
                            <div class="product-img">
                                <div class="picture">
                                    ...
                                    <div class="img-overlay">
                                                  <form method="post" action="sproduct.php">    
                                             <button type="submit" name="submit" value="images/dummy/most-popular-products/popular-2.jpg.pagespeed.ce.U8hMsHwY8o.jpg" class="btn more btn-primary">
                                             More
                                             </button>
                                             <input type="hidden" name="rs" value="3000">
                            ...
                            <div class="main-titles no-margin">
                                <h4 class="title">₹  3000</h4>
                                <h5 class="no-margin">Johnhills shirt</h5>
                            </div>
                            <p class="desc">Diwali Dhamaka offer 52% Off Mobiles and Clothing on the Best Price</p>
                            <div class="row-fluid hidden-line">
                                <div class="span6">
                        ...
                        <div class="product-inner">
                            <div class="product-img">
                                <div class="picture">
                                    ...
                                    <div class="img-overlay">
                                                    <form method="post" action="sproduct.php">    
                                             <button type="submit" name="submit" value="images/dummy/most-popular-products/popular-3.jpg.pagespeed.ce.u-SY_Zktae.jpg" class="btn more btn-primary">
                                             More
                                             </button>
                                             <input type="hidden" name="rs" value="2000">
                                             <input type="hidden" name="pname" value="Horsef T-shirt">
                                            <a href="#" class="btn buy btn-danger">Buy</a>
                            ...
                            <div class="main-titles no-margin">
                                <h4 class="title">₹  2000</h4>
                                <h5 class="no-margin">Horsef T-shirt</h5>
                            </div>
                            <p class="desc">Diwali Dhamaka offer 52% Off Mobiles and Clothing on the Best Price</p>
                            <div class="row-fluid hidden-line">
                                <div class="span6">
                        ...
                        <div class="product-inner">
                            <div class="product-img">
                                <div class="picture">
                                    ...
                                    <div class="img-overlay">
                                                   <form method="post" action="sproduct.php">    
                                             <button type="submit" name="submit" value="images/dummy/most-popular-products/popular-4.jpg.pagespeed.ce.-IcA20B0J5.jpg" class="btn more btn-primary">
                                             More
                                             </button>
                                             <input type="hidden" name="rs" value="5345">
                                             <input type="hidden" name="pname" value="Live Today shirt">
                                            <a href="#" class="btn buy btn-danger">Buy</a>
                            ...
                            <div class="main-titles no-margin">
                                <h4 class="title">₹  5345</h4>
                                <h5 class="no-margin">Live Today shirt</h5>
                            </div>
                            <p class="desc">Diwali Dhamaka offer 52% Off Mobiles and Clothing on the Best Price</p>
                            <div class="row-fluid hidden-line">
                                <div class="span6">
        ...
        <div class="modal-body">
            ...
            <form method="post" action="sregister.php">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="name" value="" class="input-block-level"  placeholder="Username" required>
                    </div>
                </div>
                <div class="control-group">
